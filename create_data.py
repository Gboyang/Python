...
def random_phone():
    ...
    return random.choice(head)+"".join(random.choice("0123456789") for i in range(8))


class Main:
    def __init__(self):
        self.__db_host = '10.0.0.50'
        self.__db_post = 5106
        self.__db_user = 'root'
        self.__db_pass = ''
        self.__db_database = 'my_test'
        self.__db_charset = 'utf8'
